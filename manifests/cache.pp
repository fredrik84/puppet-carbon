...
define carbon::cache (
  ...
  Optional[Integer[0]]                       $max_updates_per_second             = undef,
  Optional[Integer[0]]                       $max_updates_per_second_on_shutdown = undef,
  Optional[Integer[0]]                       $max_creates_per_minute             = undef,
  ...
  Optional[Enum['max', 'naive', 'sorted']]   $cache_write_strategy               = undef,
